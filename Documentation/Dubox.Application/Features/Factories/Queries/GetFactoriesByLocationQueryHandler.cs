...
public class GetFactoriesByLocationQueryHandler : IRequestHandler<GetFactoriesByLocationQuery, Result<List<FactoryDto>>>
{
    private readonly IUnitOfWork _unitOfWork;
    private readonly IDbContext _dbContext;

    public GetFactoriesByLocationQueryHandler(IUnitOfWork unitOfWork, IDbContext dbContext)
    {
