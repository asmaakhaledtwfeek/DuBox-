...
namespace Dubox.Application.DTOs
{
    ...
    public class WIRCheckpointDto
    {
        ...
        /// <summary>Project creator user id - used by frontend to allow project creator to review checkpoints.</summary>
        public Guid? ProjectCreatedBy { get; set; }
        /// <summary>Project manager user id - used by frontend to allow project manager to review checkpoints.</summary>
