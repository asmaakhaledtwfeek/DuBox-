...
{
    public class GetBoxAttachmentsQueryHandler : IRequestHandler<GetBoxAttachmentsQuery, Result<List<ProgressUpdateImageDto>>>
    {
        private readonly IUnitOfWork _unitOfWork;
        public GetBoxAttachmentsQueryHandler(IUnitOfWork unitOfWork)
        {
            _unitOfWork = unitOfWork;
        }
        public async Task<Result<List<ProgressUpdateImageDto>>> Handle(GetBoxAttachmentsQuery request, CancellationToken cancellationToken)
        {
