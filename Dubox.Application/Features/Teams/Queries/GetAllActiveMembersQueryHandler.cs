...
public class GetAllActiveMembersQueryHandler : IRequestHandler<GetAllActiveMembersQuery, Result<List<TeamMemberDto>>>
{
    ...
    public GetAllActiveMembersQueryHandler(IUnitOfWork unitOfWork)
    {
    ...
    {
        var activeMembers =  _unitOfWork.Repository<TeamMember>()
            .GetWithSpec(new GetAllTeamMembersSpecification()).Data.ToList();
