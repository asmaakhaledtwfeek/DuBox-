    ...
    internal class MapsterConfig : IRegister
    {
        ...
        public void Register(TypeAdapterConfig config)
        {
            ...
            TypeAdapterConfig<QualityIssue, QualityIssueDto>.NewConfig()
                ...
                .Map(dest => dest.IssueType, src => src.IssueType != null ? src.IssueType.ToString() : string.Empty)
                ...
                .Map(dest => dest.DueDate, src => src.DueDate ?? default(DateTime))
                .Map(dest => dest.IssueDate, src => src.IssueDate)
                .Map(dest => dest.ReportedBy, src => src.ReportedBy)
                .Map(dest => dest.Status, src => src.Status)
                .Map(dest => dest.Images, src => src.Images ?? new List<QualityIssueImage>())
...
;
            ...
            TypeAdapterConfig<WIRCheckpoint, WIRCheckpointDto>.NewConfig()
                ...
                .Map(dest => dest.ChecklistItems, src => src.ChecklistItems ?? new List<WIRChecklistItem>())
                .Map(dest => dest.QualityIssues, src => src.QualityIssues ?? new List<QualityIssue>())
                .Map(dest => dest.Images, src => src.Images ?? new List<WIRCheckpointImage>())
                .Map(dest => dest.PendingDays, src => src.PendingDays)
                .Map(dest => dest.IsOverdue, src => src.IsOverdue)
                .Ignore(dest => dest.Box)
                ...
                .Map(dest => dest.ProjectCreatedBy, src => src.Box != null && src.Box.Project != null ? src.Box.Project.CreatedBy : (Guid?)null)
                .Map(dest => dest.ProjectManagerId, src => src.Box != null && src.Box.Project != null ? src.Box.Project.ProjectMangerId : (Guid?)null)
