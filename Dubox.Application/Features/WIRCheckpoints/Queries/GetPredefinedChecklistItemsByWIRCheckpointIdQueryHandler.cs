...
public class GetPredefinedChecklistItemsByWIRCheckpointIdQueryHandler
    : IRequestHandler<GetPredefinedChecklistItemsByWIRCheckpointIdQuery, Result<List<PredefinedChecklistItemWithChecklistDto>>>
{
    private readonly IUnitOfWork _unitOfWork;

    public GetPredefinedChecklistItemsByWIRCheckpointIdQueryHandler(IUnitOfWork unitOfWork)
    {
        _unitOfWork = unitOfWork;
    }

    public async Task<Result<List<PredefinedChecklistItemWithChecklistDto>>> Handle(GetPredefinedChecklistItemsByWIRCheckpointIdQuery request, CancellationToken cancellationToken)
    {
