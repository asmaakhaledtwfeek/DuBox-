...
namespace Dubox.Infrastructure.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "TeamId");
                    table.ForeignKey(
                        name: "FK_BoxActivities_Users_AssignedUserId",
            ...
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "UserId", "CreatedDate", "Department", "Email", "FullName", "IsActive", "LastLoginDate", "PasswordHash" },
                values: new object[,]
                {
                    { new Guid("f0000001-0000-0000-0000-000000000001"), new DateTime(2024, 11, 1, 0, 0, 0, 0, DateTimeKind.Utc), "DuBox", "rania.khalifa@groupamana.com", "Rania Khalifa", true, null, "AQIDBAUGBwgJCgsMDQ4PEL47IPnruFDHjvgQn4gt+aHjj9Wvhi+9Lw6p4tvk8d7H" },
                    { new Guid("f0000002-0000-0000-0000-000000000002"), new DateTime(2024, 11, 1, 0, 0, 0, 0, DateTimeKind.Utc), "DuBox", "salim.rashid@groupamana.com", "Salim Rashid", true, null, "AQIDBAUGBwgJCgsMDQ4PEL47IPnruFDHjvgQn4gt+aHjj9Wvhi+9Lw6p4tvk8d7H" },
                    { new Guid("f0000003-0000-0000-0000-000000000003"), new DateTime(2024, 11, 1, 0, 0, 0, 0, DateTimeKind.Utc), "DuPod", "huda.almarri@groupamana.com", "Huda Al Marri", true, null, "AQIDBAUGBwgJCgsMDQ4PEL47IPnruFDHjvgQn4gt+aHjj9Wvhi+9Lw6p4tvk8d7H" },
                    { new Guid("f0000004-0000-0000-0000-000000000004"), new DateTime(2024, 11, 1, 0, 0, 0, 0, DateTimeKind.Utc), "DuPod", "faisal.sultan@groupamana.com", "Faisal Sultan", true, null, "AQIDBAUGBwgJCgsMDQ4PEL47IPnruFDHjvgQn4gt+aHjj9Wvhi+9Lw6p4tvk8d7H" },
                    { new Guid("f1111111-1111-1111-1111-111111111111"), new DateTime(2024, 11, 1, 0, 0, 0, 0, DateTimeKind.Utc), "IT", "admin@groupamana.com", "System Administrator", true, null, "AQIDBAUGBwgJCgsMDQ4PEL47IPnruFDHjvgQn4gt+aHjj9Wvhi+9Lw6p4tvk8d7H" },
                    { new Guid("f2222222-2222-2222-2222-222222222222"), new DateTime(2024, 11, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Management", "ahmed.almazrouei@groupamana.com", "Ahmed Al Mazrouei", true, null, "AQIDBAUGBwgJCgsMDQ4PEL47IPnruFDHjvgQn4gt+aHjj9Wvhi+9Lw6p4tvk8d7H" },
                    { new Guid("f3333333-3333-3333-3333-333333333333"), new DateTime(2024, 11, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Management", "sara.alkhan@groupamana.com", "Sara Al Khan", true, null, "AQIDBAUGBwgJCgsMDQ4PEL47IPnruFDHjvgQn4gt+aHjj9Wvhi+9Lw6p4tvk8d7H" },
                    { new Guid("f4444444-4444-4444-4444-444444444444"), new DateTime(2024, 11, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Engineering", "mohammed.hassan@groupamana.com", "Mohammed Hassan", true, null, "AQIDBAUGBwgJCgsMDQ4PEL47IPnruFDHjvgQn4gt+aHjj9Wvhi+9Lw6p4tvk8d7H" },
                    { new Guid("f5555555-5555-5555-5555-555555555555"), new DateTime(2024, 11, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Engineering", "fatima.alali@groupamana.com", "Fatima Al Ali", true, null, "AQIDBAUGBwgJCgsMDQ4PEL47IPnruFDHjvgQn4gt+aHjj9Wvhi+9Lw6p4tvk8d7H" },
                    { new Guid("f6666666-6666-6666-6666-666666666666"), new DateTime(2024, 11, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Engineering", "khalid.omar@groupamana.com", "Khalid Omar", true, null, "AQIDBAUGBwgJCgsMDQ4PEL47IPnruFDHjvgQn4gt+aHjj9Wvhi+9Lw6p4tvk8d7H" },
                    { new Guid("f7777777-7777-7777-7777-777777777777"), new DateTime(2024, 11, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Construction", "ali.mohammed@groupamana.com", "Ali Mohammed", true, null, "AQIDBAUGBwgJCgsMDQ4PEL47IPnruFDHjvgQn4gt+aHjj9Wvhi+9Lw6p4tvk8d7H" },
                    { new Guid("f8888888-8888-8888-8888-888888888888"), new DateTime(2024, 11, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Construction", "omar.saleh@groupamana.com", "Omar Saleh", true, null, "AQIDBAUGBwgJCgsMDQ4PEL47IPnruFDHjvgQn4gt+aHjj9Wvhi+9Lw6p4tvk8d7H" },
                    { new Guid("f9999999-9999-9999-9999-999999999999"), new DateTime(2024, 11, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Construction", "youssef.ahmed@groupamana.com", "Youssef Ahmed", true, null, "AQIDBAUGBwgJCgsMDQ4PEL47IPnruFDHjvgQn4gt+aHjj9Wvhi+9Lw6p4tvk8d7H" },
                    { new Guid("faaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa"), new DateTime(2024, 11, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Quality", "layla.ibrahim@groupamana.com", "Layla Ibrahim", true, null, "AQIDBAUGBwgJCgsMDQ4PEL47IPnruFDHjvgQn4gt+aHjj9Wvhi+9Lw6p4tvk8d7H" },
                    { new Guid("fbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb"), new DateTime(2024, 11, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Quality", "hamza.khalil@groupamana.com", "Hamza Khalil", true, null, "AQIDBAUGBwgJCgsMDQ4PEL47IPnruFDHjvgQn4gt+aHjj9Wvhi+9Lw6p4tvk8d7H" },
                    { new Guid("fccccccc-cccc-cccc-cccc-cccccccccccc"), new DateTime(2024, 11, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Procurement", "noor.alhassan@groupamana.com", "Noor Al Hassan", true, null, "AQIDBAUGBwgJCgsMDQ4PEL47IPnruFDHjvgQn4gt+aHjj9Wvhi+9Lw6p4tvk8d7H" },
                    { new Guid("fddddddd-dddd-dddd-dddd-dddddddddddd"), new DateTime(2024, 11, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Procurement", "zaid.mansour@groupamana.com", "Zaid Mansour", true, null, "AQIDBAUGBwgJCgsMDQ4PEL47IPnruFDHjvgQn4gt+aHjj9Wvhi+9Lw6p4tvk8d7H" },
                    { new Guid("feeeeeee-eeee-eeee-eeee-eeeeeeeeeeee"), new DateTime(2024, 11, 1, 0, 0, 0, 0, DateTimeKind.Utc), "HSE", "maryam.Said@groupamana.com", "Maryam Said", true, null, "AQIDBAUGBwgJCgsMDQ4PEL47IPnruFDHjvgQn4gt+aHjj9Wvhi+9Lw6p4tvk8d7H" },
                    { new Guid("ffffffff-ffff-ffff-ffff-ffffffffffff"), new DateTime(2024, 11, 1, 0, 0, 0, 0, DateTimeKind.Utc), "HSE", "tariq.abdullah@groupamana.com", "Tariq Abdullah", true, null, "AQIDBAUGBwgJCgsMDQ4PEL47IPnruFDHjvgQn4gt+aHjj9Wvhi+9Lw6p4tvk8d7H" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BoxActivities_AssignedUserId",
                table: "BoxActivities",
