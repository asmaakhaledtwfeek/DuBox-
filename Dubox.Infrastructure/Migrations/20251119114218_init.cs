    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("10000001-0000-0000-0000-000000000001"), "STAGE2-ASM", "Assembly & joints", null, new DateTime(2024, 11, 1, 0, 0, 0, 0, DateTimeKind.Utc), null, "Assembly of box components and joint connections", 1, true, false, 1, 1, "Stage 2: Module Assembly", 2, null },
                    { new Guid("10000001-0000-0000-0000-000000000002"), "STAGE2-POD", "PODS installation", null, new DateTime(2024, 11, 1, 0, 0, 0, 0, DateTimeKind.Utc), null, "Installation of pre-assembled bathroom and kitchen PODs", 1, true, false, 2, 2, "Stage 2: Module Assembly", 2, null },
                    { new Guid("10000001-0000-0000-0000-000000000003"), "STAGE2-MEP", "MEP Cage installation", null, new DateTime(2024, 11, 1, 0, 0, 0, 0, DateTimeKind.Utc), null, "Installation of pre-assembled MEP cages", 1, true, false, 3, 3, "Stage 2: Module Assembly", 2, null },
                    { new Guid("10000001-0000-0000-0000-000000000004"), "STAGE2-CLO", "Box Closure", null, new DateTime(2024, 11, 1, 0, 0, 0, 0, DateTimeKind.Utc), null, "Final closure and sealing of box module - triggers WIR-1", 1, true, true, 4, 4, "Stage 2: Module Assembly", 2, "WIR-1" },
                    { new Guid("10000002-0000-0000-0000-000000000001"), "STAGE3-DCT", "Ducts & Insulation", null, new DateTime(2024, 11, 1, 0, 0, 0, 0, DateTimeKind.Utc), null, "Installation and insulation of HVAC ductwork", 2, true, false, 5, 1, "Stage 3: MEP Phase 1", 3, null },
                    { new Guid("10000002-0000-0000-0000-000000000002"), "STAGE3-DRN", "Drainage piping", null, new DateTime(2024, 11, 1, 0, 0, 0, 0, DateTimeKind.Utc), null, "Installation of drainage and wastewater piping", 2, true, false, 6, 2, "Stage 3: MEP Phase 1", 3, null },
                    { new Guid("10000002-0000-0000-0000-000000000003"), "STAGE3-WTR", "Water Piping", null, new DateTime(2024, 11, 1, 0, 0, 0, 0, DateTimeKind.Utc), null, "Installation of domestic water supply piping", 2, true, false, 7, 3, "Stage 3: MEP Phase 1", 3, null },
                    { new Guid("10000002-0000-0000-0000-000000000004"), "STAGE3-FF", "Fire Fighting Piping", null, new DateTime(2024, 11, 1, 0, 0, 0, 0, DateTimeKind.Utc), null, "Installation of fire protection and sprinkler piping - triggers WIR-2", 2, true, true, 8, 4, "Stage 3: MEP Phase 1", 3, "WIR-2" },
                    { new Guid("10000003-0000-0000-0000-000000000001"), "STAGE4-ELCC", "Electrical Containment", null, new DateTime(2024, 11, 1, 0, 0, 0, 0, DateTimeKind.Utc), null, "Final electrical conduit and containment installation", 2, true, false, 9, 1, "Stage 4: Electrical & Framing", 4, null },
                    { new Guid("10000003-0000-0000-0000-000000000002"), "STAGE4-WIRE", "Electrical Wiring", null, new DateTime(2024, 11, 1, 0, 0, 0, 0, DateTimeKind.Utc), null, "Pulling and termination of electrical wiring", 2, true, false, 10, 2, "Stage 4: Electrical & Framing", 4, null },
                    { new Guid("10000003-0000-0000-0000-000000000003"), "STAGE4-DRYWALL", "Dry Wall Framing", null, new DateTime(2024, 11, 1, 0, 0, 0, 0, DateTimeKind.Utc), null, "Installation of drywall framing and metal studs", 2, true, false, 11, 3, "Stage 4: Electrical & Framing", 4, null },
                    { new Guid("10000003-0000-0000-0000-000000000004"), "STAGE4-DB", "DB and ONU Panel", null, new DateTime(2024, 11, 1, 0, 0, 0, 0, DateTimeKind.Utc), null, "Installation of distribution board and ONU network panels - triggers WIR-3", 2, true, true, 12, 4, "Stage 4: Electrical & Framing", 4, "WIR-3" },
                    { new Guid("10000004-0000-0000-0000-000000000001"), "STAGE5-CEILING", "False Ceiling", null, new DateTime(2024, 11, 1, 0, 0, 0, 0, DateTimeKind.Utc), null, "Installation of suspended ceiling systems", 1, true, false, 13, 1, "Stage 5: Interior Finishing", 5, null },
                    { new Guid("10000004-0000-0000-0000-000000000002"), "STAGE5-TILE", "Tile Fixing", null, new DateTime(2024, 11, 1, 0, 0, 0, 0, DateTimeKind.Utc), null, "Installation of floor and wall tiles", 2, true, false, 14, 2, "Stage 5: Interior Finishing", 5, null },
                    { new Guid("10000004-0000-0000-0000-000000000003"), "STAGE5-PAINT", "Painting (Internal & External)", null, new DateTime(2024, 11, 1, 0, 0, 0, 0, DateTimeKind.Utc), null, "Interior and exterior painting and finishing", 2, true, false, 15, 3, "Stage 5: Interior Finishing", 5, null },
                    { new Guid("10000004-0000-0000-0000-000000000004"), "STAGE5-KITCHEN", "Kitchenette and Counters", "Kitchen,Living Room", new DateTime(2024, 11, 1, 0, 0, 0, 0, DateTimeKind.Utc), null, "Installation of kitchen units and countertops", 1, true, false, 16, 4, "Stage 5: Interior Finishing", 5, null },
                    { new Guid("10000004-0000-0000-0000-000000000005"), "STAGE5-DOORS", "Doors", null, new DateTime(2024, 11, 1, 0, 0, 0, 0, DateTimeKind.Utc), null, "Installation of interior doors and frames", 1, true, false, 17, 5, "Stage 5: Interior Finishing", 5, null },
                    { new Guid("10000004-0000-0000-0000-000000000006"), "STAGE5-WINDOWS", "Windows", null, new DateTime(2024, 11, 1, 0, 0, 0, 0, DateTimeKind.Utc), null, "Installation of windows and glazing - triggers WIR-4", 1, true, true, 18, 6, "Stage 5: Interior Finishing", 5, "WIR-4" },
                    { new Guid("10000005-0000-0000-0000-000000000001"), "STAGE6-SWITCH", "Switches & Sockets", null, new DateTime(2024, 11, 1, 0, 0, 0, 0, DateTimeKind.Utc), null, "Installation of electrical switches and power sockets", 2, true, false, 19, 1, "Stage 6: MEP Phase 2", 6, null },
                    { new Guid("10000005-0000-0000-0000-000000000002"), "STAGE6-LIGHTS", "Light Fittings", null, new DateTime(2024, 11, 1, 0, 0, 0, 0, DateTimeKind.Utc), null, "Installation of light fixtures and fittings", 2, true, false, 20, 2, "Stage 6: MEP Phase 2", 6, null },
                    { new Guid("10000005-0000-0000-0000-000000000003"), "STAGE6-COPPER", "Copper Piping", null, new DateTime(2024, 11, 1, 0, 0, 0, 0, DateTimeKind.Utc), null, "Installation of copper piping for specialized systems", 2, true, false, 21, 3, "Stage 6: MEP Phase 2", 6, null },
                    { new Guid("10000005-0000-0000-0000-000000000004"), "STAGE6-SANITARY", "Sanitary Fittings - Kitchen", null, new DateTime(2024, 11, 1, 0, 0, 0, 0, DateTimeKind.Utc), null, "Installation of kitchen and sanitary fixtures", 2, true, false, 22, 4, "Stage 6: MEP Phase 2", 6, null },
                    { new Guid("10000005-0000-0000-0000-000000000005"), "STAGE6-THERMO", "Thermostats", null, new DateTime(2024, 11, 1, 0, 0, 0, 0, DateTimeKind.Utc), null, "Installation of HVAC thermostats and controls", 2, true, false, 23, 5, "Stage 6: MEP Phase 2", 6, null },
                    { new Guid("10000005-0000-0000-0000-000000000006"), "STAGE6-AIROUT", "Air Outlet", null, new DateTime(2024, 11, 1, 0, 0, 0, 0, DateTimeKind.Utc), null, "Installation of HVAC air outlets and diffusers", 2, true, false, 24, 6, "Stage 6: MEP Phase 2", 6, null },
                    { new Guid("10000005-0000-0000-0000-000000000007"), "STAGE6-SPRINKLER", "Sprinkler", null, new DateTime(2024, 11, 1, 0, 0, 0, 0, DateTimeKind.Utc), null, "Installation of fire sprinkler heads", 2, true, false, 25, 7, "Stage 6: MEP Phase 2", 6, null },
                    { new Guid("10000005-0000-0000-0000-000000000008"), "STAGE6-SMOKE", "Smoke Detector", null, new DateTime(2024, 11, 1, 0, 0, 0, 0, DateTimeKind.Utc), null, "Installation of smoke detectors and fire alarm devices - triggers WIR-5", 2, true, true, 26, 8, "Stage 6: MEP Phase 2", 6, "WIR-5" },
                    { new Guid("10000006-0000-0000-0000-000000000001"), "STAGE7-IRON", "Iron Mongeries", null, new DateTime(2024, 11, 1, 0, 0, 0, 0, DateTimeKind.Utc), null, "Installation of door handles, locks, hinges and other hardware", 1, true, false, 27, 1, "Stage 7: Final Inspection & Dispatch", 7, null },
                    { new Guid("10000006-0000-0000-0000-000000000002"), "STAGE7-WRAP", "Inspection & Wrapping", null, new DateTime(2024, 11, 1, 0, 0, 0, 0, DateTimeKind.Utc), null, "Comprehensive final quality inspection and protective wrapping - triggers WIR-6", 1, true, true, 28, 2, "Stage 7: Final Inspection & Dispatch", 7, "WIR-6" }
                });
