...
{
    /// <inheritdoc />
    public partial class seedingPredefinedChecklistItem : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                columns: new[] { "CategoryId", "CheckpointDescription", "ItemNumber", "ReferenceId", "WIRNumber" },
                values: new object[] { new Guid("40000001-0000-0000-0000-000000000002"), "Ensure the materials as per approved material submittal.", "A1", new Guid("30000001-0000-0000-0000-000000000003"), "WIR-2" });
            ...
            migrationBuilder.UpdateData(
                ...
                columns: new[] { "CategoryId", "CheckpointDescription", "ItemNumber", "ReferenceId", "WIRNumber" },
                values: new object[] { new Guid("40000001-0000-0000-0000-000000000002"), "Ensure drawings are used for installation are current and approved.", "A2", new Guid("30000001-0000-0000-0000-000000000002"), "WIR-2" });
            ...
            migrationBuilder.UpdateData(
                ...
                columns: new[] { "CategoryId", "CheckpointDescription", "ItemNumber", "ReferenceId", "WIRNumber" },
                values: new object[] { new Guid("40000001-0000-0000-0000-000000000001"), "Check that only in properly fabricated fittings are used for changes in directions, shapes,sizes and connections.", "A3", new Guid("30000001-0000-0000-0000-000000000004"), "WIR-2" });
            ...
            migrationBuilder.UpdateData(
                ...
                columns: new[] { "CategoryId", "CheckpointDescription", "ItemNumber", "ReferenceId", "WIRNumber" },
                values: new object[] { new Guid("40000001-0000-0000-0000-000000000001"), "The joints and flanges are correctly made, jointed and sealed.", "A4", new Guid("30000001-0000-0000-0000-000000000004"), "WIR-2" });
            ...
            migrationBuilder.UpdateData(
                ...
                columns: new[] { "CategoryId", "CheckpointDescription", "ItemNumber", "ReferenceId", "WIRNumber" },
                values: new object[] { new Guid("40000001-0000-0000-0000-000000000001"), "Check that duct joints are sealed externally with approved sealant.", "A5", new Guid("30000001-0000-0000-0000-000000000004"), "WIR-2" });
            ...
            migrationBuilder.UpdateData(
                ...
                columns: new[] { "CategoryId", "CheckpointDescription", "ItemNumber", "ReferenceId", "WIRNumber" },
                values: new object[] { new Guid("40000001-0000-0000-0000-000000000001"), "Check fixing of supports and spacing as approved drawings & submittal.", "A6", new Guid("30000001-0000-0000-0000-000000000002"), "WIR-2" });
            ...
            migrationBuilder.UpdateData(
                ...
                columns: new[] { "CategoryId", "CheckpointDescription", "ItemNumber", "ReferenceId", "WIRNumber" },
                values: new object[] { new Guid("40000001-0000-0000-0000-000000000001"), "Check acoustic lining is properly fastened and un damaged.", "A7", new Guid("30000001-0000-0000-0000-000000000002"), "WIR-2" });
            ...
            migrationBuilder.UpdateData(
                ...
                columns: new[] { "CategoryId", "CheckpointDescription", "ItemNumber", "ReferenceId", "WIRNumber" },
                values: new object[] { new Guid("40000001-0000-0000-0000-000000000001"), "Check nuts, bolts, screws, brackets drop rods etc. are tight and aligned properly.", "A8", new Guid("30000001-0000-0000-0000-000000000002"), "WIR-2" });
            ...
            migrationBuilder.UpdateData(
                ...
                columns: new[] { "CategoryId", "CheckpointDescription", "ItemNumber", "ReferenceId", "WIRNumber" },
                values: new object[] { new Guid("40000001-0000-0000-0000-000000000001"), "All the access doors, fire dampers,VCDs etc are installed as per approved drawings, specification and manufacturer instructions as applicable.", "A9", new Guid("30000001-0000-0000-0000-000000000002"), "WIR-2" });
            ...
            migrationBuilder.UpdateData(
                ...
                columns: new[] { "CategoryId", "CheckpointDescription", "ItemNumber", "ReferenceId", "WIRNumber" },
                values: new object[] { new Guid("40000001-0000-0000-0000-000000000001"), "Ensure that the identification & labeling are provided for duct works.", "A10", new Guid("30000001-0000-0000-0000-000000000002"), "WIR-2" });
            ...
            migrationBuilder.UpdateData(
                ...
                columns: new[] { "CategoryId", "CheckpointDescription", "ItemNumber", "ReferenceId", "WIRNumber" },
                values: new object[] { new Guid("40000001-0000-0000-0000-000000000003"), "Ensure the materials are approved", "A1", new Guid("30000001-0000-0000-0000-000000000005"), "WIR-2" });
            ...
            migrationBuilder.UpdateData(
                ...
                columns: new[] { "CategoryId", "CheckpointDescription", "ItemNumber", "ReferenceId", "WIRNumber" },
                values: new object[] { new Guid("40000001-0000-0000-0000-000000000003"), "No visible damage on the materials", "A2", new Guid("30000001-0000-0000-0000-000000000004"), "WIR-2" });
            ...
            migrationBuilder.UpdateData(
                ...
                columns: new[] { "CategoryId", "CheckpointDescription", "ItemNumber", "ReferenceId", "WIRNumber" },
                values: new object[] { new Guid("40000001-0000-0000-0000-000000000003"), "Pipe sizes are as per approved shop drawing", "A3", new Guid("30000001-0000-0000-0000-000000000002"), "WIR-2" });
            ...
            migrationBuilder.UpdateData(
                ...
                columns: new[] { "CategoryId", "CheckpointDescription", "ItemNumber", "ReferenceId", "WIRNumber" },
                values: new object[] { new Guid("40000001-0000-0000-0000-000000000003"), "Pipe layout/routing as per approved shop drawing", "A4", new Guid("30000001-0000-0000-0000-000000000002"), "WIR-2" });
            ...
            migrationBuilder.UpdateData(
                ...
                columns: new[] { "CategoryId", "CheckpointDescription", "ItemNumber", "ReferenceId", "WIRNumber" },
                values: new object[] { new Guid("40000001-0000-0000-0000-000000000003"), "Slope of the pipes as per approved shop drawing", "A5", new Guid("30000001-0000-0000-0000-000000000002"), "WIR-2" });
            ...
            migrationBuilder.UpdateData(
                ...
                columns: new[] { "CategoryId", "CheckpointDescription", "ItemNumber", "ReferenceId", "WIRNumber" },
                values: new object[] { new Guid("40000001-0000-0000-0000-000000000003"), "Installation as per approved method statement", "A6", new Guid("30000001-0000-0000-0000-000000000007"), "WIR-2" });
            ...
            migrationBuilder.UpdateData(
                ...
                columns: new[] { "CategoryId", "CheckpointDescription", "ItemNumber", "ReferenceId", "WIRNumber" },
                values: new object[] { new Guid("40000001-0000-0000-0000-000000000003"), "Sleeves are provided for the pipes passing through the walls /slabs", "A7", new Guid("30000001-0000-0000-0000-000000000002"), "WIR-2" });
            ...
            migrationBuilder.UpdateData(
                ...
                columns: new[] { "CategoryId", "CheckpointDescription", "ItemNumber", "ReferenceId", "WIRNumber" },
                values: new object[] { new Guid("40000001-0000-0000-0000-000000000003"), "Check the pipes are supported well with approved clamps.", "A8", new Guid("30000001-0000-0000-0000-000000000002"), "WIR-2" });
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DeleteData(
                table: "Categories",
                keyColumn: "CategoryId",
                keyValue: new Guid("40000001-0000-0000-0000-000000000002"));
            ...
            migrationBuilder.DeleteData(
                table: "References",
                keyColumn: "ReferenceId",
                keyValue: new Guid("30000001-0000-0000-0000-000000000006"));

            migrationBuilder.DeleteData(
                table: "References",
                keyColumn: "ReferenceId",
                keyValue: new Guid("30000001-0000-0000-0000-000000000009"));

            migrationBuilder.DeleteData(
                table: "References",
                keyColumn: "ReferenceId",
                keyValue: new Guid("30000001-0000-0000-0000-000000000012"));

            migrationBuilder.DeleteData(
                table: "References",
                keyColumn: "ReferenceId",
                keyValue: new Guid("30000001-0000-0000-0000-000000000016"));

            migrationBuilder.DeleteData(
                table: "References",
                keyColumn: "ReferenceId",
                keyValue: new Guid("30000001-0000-0000-0000-000000000022"));

            migrationBuilder.DeleteData(
                table: "References",
                keyColumn: "ReferenceId",
                keyValue: new Guid("30000001-0000-0000-0000-000000000024"));

            migrationBuilder.DeleteData(
                table: "Categories",
                keyColumn: "CategoryId",
                keyValue: new Guid("40000001-0000-0000-0000-000000000003"));

            migrationBuilder.DeleteData(
                table: "Categories",
                keyColumn: "CategoryId",
                keyValue: new Guid("40000001-0000-0000-0000-000000000004"));

            migrationBuilder.DeleteData(
                table: "Categories",
                keyColumn: "CategoryId",
                keyValue: new Guid("40000001-0000-0000-0000-000000000005"));

            migrationBuilder.DeleteData(
                table: "Categories",
                keyColumn: "CategoryId",
                keyValue: new Guid("40000001-0000-0000-0000-000000000006"));

            migrationBuilder.DeleteData(
                table: "Categories",
                keyColumn: "CategoryId",
                keyValue: new Guid("40000001-0000-0000-0000-000000000007"));

            migrationBuilder.DeleteData(
                table: "Categories",
                keyColumn: "CategoryId",
                keyValue: new Guid("40000001-0000-0000-0000-000000000008"));

            migrationBuilder.DeleteData(
                table: "Categories",
                keyColumn: "CategoryId",
                keyValue: new Guid("40000001-0000-0000-0000-000000000009"));

            migrationBuilder.DeleteData(
                table: "Categories",
                keyColumn: "CategoryId",
                keyValue: new Guid("40000001-0000-0000-0000-000000000010"));

            migrationBuilder.DeleteData(
                table: "Categories",
                keyColumn: "CategoryId",
                keyValue: new Guid("40000001-0000-0000-0000-000000000011"));

            migrationBuilder.DeleteData(
                table: "Categories",
                keyColumn: "CategoryId",
                keyValue: new Guid("40000001-0000-0000-0000-000000000012"));

            migrationBuilder.DeleteData(
                table: "Categories",
                keyColumn: "CategoryId",
                keyValue: new Guid("40000001-0000-0000-0000-000000000013"));

            migrationBuilder.DeleteData(
                table: "Categories",
                keyColumn: "CategoryId",
                keyValue: new Guid("40000001-0000-0000-0000-000000000014"));

            migrationBuilder.DeleteData(
                table: "References",
                keyColumn: "ReferenceId",
                keyValue: new Guid("30000001-0000-0000-0000-000000000002"));

            migrationBuilder.DeleteData(
                table: "References",
                keyColumn: "ReferenceId",
                keyValue: new Guid("30000001-0000-0000-0000-000000000003"));

            migrationBuilder.DeleteData(
                table: "References",
                keyColumn: "ReferenceId",
                keyValue: new Guid("30000001-0000-0000-0000-000000000004"));

            migrationBuilder.DeleteData(
                table: "References",
                keyColumn: "ReferenceId",
                keyValue: new Guid("30000001-0000-0000-0000-000000000005"));

            migrationBuilder.DeleteData(
                table: "References",
                keyColumn: "ReferenceId",
                keyValue: new Guid("30000001-0000-0000-0000-000000000007"));

            migrationBuilder.DeleteData(
                table: "References",
                keyColumn: "ReferenceId",
                keyValue: new Guid("30000001-0000-0000-0000-000000000008"));

            migrationBuilder.DeleteData(
                table: "References",
                keyColumn: "ReferenceId",
                keyValue: new Guid("30000001-0000-0000-0000-000000000010"));

            migrationBuilder.DeleteData(
                table: "References",
                keyColumn: "ReferenceId",
                keyValue: new Guid("30000001-0000-0000-0000-000000000011"));

            migrationBuilder.DeleteData(
                table: "References",
                keyColumn: "ReferenceId",
                keyValue: new Guid("30000001-0000-0000-0000-000000000013"));

            migrationBuilder.DeleteData(
                table: "References",
                keyColumn: "ReferenceId",
                keyValue: new Guid("30000001-0000-0000-0000-000000000014"));

            migrationBuilder.DeleteData(
                table: "References",
                keyColumn: "ReferenceId",
                keyValue: new Guid("30000001-0000-0000-0000-000000000015"));

            migrationBuilder.DeleteData(
                table: "References",
                keyColumn: "ReferenceId",
                keyValue: new Guid("30000001-0000-0000-0000-000000000017"));

            migrationBuilder.DeleteData(
                table: "References",
                keyColumn: "ReferenceId",
                keyValue: new Guid("30000001-0000-0000-0000-000000000018"));

            migrationBuilder.DeleteData(
                table: "References",
                keyColumn: "ReferenceId",
                keyValue: new Guid("30000001-0000-0000-0000-000000000019"));

            migrationBuilder.DeleteData(
                table: "References",
                keyColumn: "ReferenceId",
                keyValue: new Guid("30000001-0000-0000-0000-000000000020"));

            migrationBuilder.DeleteData(
                table: "References",
                keyColumn: "ReferenceId",
                keyValue: new Guid("30000001-0000-0000-0000-000000000021"));

            migrationBuilder.DeleteData(
                table: "References",
                keyColumn: "ReferenceId",
                keyValue: new Guid("30000001-0000-0000-0000-000000000023"));
            ...
            migrationBuilder.UpdateData(
                ...
                keyColumn: "PredefinedItemId",
                keyValue: new Guid("20000001-0000-0000-0000-000000000001"),
                columns: new[] { "CategoryId", "CheckpointDescription", "ItemNumber", "ReferenceId" },
                values: new object[] { null, "Ensure method statement, material submittal and drawings are approved.", null, null });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: new Guid("20000001-0000-0000-0000-000000000002"),
                columns: new[] { "CategoryId", "CheckpointDescription", "ItemNumber", "ReferenceId" },
                values: new object[] { null, "Ensure materials (Gypsum board, cement board, insulation material, supporting system, etc.) are stored under dry, clean, shaded area, away from sunlight and other sources of heat.", null, null });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: new Guid("20000001-0000-0000-0000-000000000003"),
                columns: new[] { "CategoryId", "CheckpointDescription", "ItemNumber", "ReferenceId" },
                values: new object[] { null, "Check the color, type, material, fire rating and thickness are as per approved material approval and project requirements.", null, null });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: new Guid("20000001-0000-0000-0000-000000000004"),
                columns: new[] { "CategoryId", "CheckpointDescription", "ItemNumber", "ReferenceId" },
                values: new object[] { null, "Verify and record the DCL product conformity certificate for the insulation materials.", null, null });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: new Guid("20000001-0000-0000-0000-000000000005"),
                columns: new[] { "CategoryId", "CheckpointDescription", "ItemNumber", "ReferenceId" },
                values: new object[] { null, "Verify the marking and setting out of the partition walls as per the approved drawings.", null, null });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: new Guid("20000001-0000-0000-0000-000000000006"),
                columns: new[] { "CategoryId", "CheckpointDescription", "ItemNumber", "ReferenceId" },
                values: new object[] { null, "Verify the completion of the required finishes of the adjacent substrates.", null, null });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: new Guid("20000001-0000-0000-0000-000000000007"),
                columns: new[] { "CategoryId", "CheckpointDescription", "ItemNumber", "ReferenceId" },
                values: new object[] { null, "Verify the location, spacing and fixation of the supporting grid (vertical and horizontal channel, wall angle, etc.) as per the approved drawings.", null, null });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: new Guid("20000001-0000-0000-0000-000000000008"),
                columns: new[] { "CategoryId", "CheckpointDescription", "ItemNumber", "ReferenceId" },
                values: new object[] { null, "Verify the fixation of the board (on one side of the supports) as per the approved drawings.", null, null });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: new Guid("20000001-0000-0000-0000-000000000009"),
                columns: new[] { "CategoryId", "CheckpointDescription", "ItemNumber", "ReferenceId" },
                values: new object[] { null, "Ensure the completion of all embedded MEP and other discipline works prior to closure as per the approved drawings.", null, null });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: new Guid("20000001-0000-0000-0000-000000000010"),
                columns: new[] { "CategoryId", "CheckpointDescription", "ItemNumber", "ReferenceId" },
                values: new object[] { null, "Ensure additional supports are provided for the wall mounted fixtures as applicable.", null, null });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: new Guid("20000001-0000-0000-0000-000000000011"),
                columns: new[] { "CategoryId", "CheckpointDescription", "ItemNumber", "ReferenceId" },
                values: new object[] { null, "Verify the installation of insulation works (if applicable) as per the approved drawings.", null, null });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: new Guid("20000001-0000-0000-0000-000000000012"),
                columns: new[] { "CategoryId", "CheckpointDescription", "ItemNumber", "ReferenceId" },
                values: new object[] { null, "Obtain approval (Civil / MEP) from consultant / Client to proceed with further works.", null, null });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: new Guid("20000001-0000-0000-0000-000000000013"),
                columns: new[] { "CategoryId", "CheckpointDescription", "ItemNumber", "ReferenceId" },
                values: new object[] { null, "Verify the fixation of the board as per the approved drawings.", null, null });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: new Guid("20000001-0000-0000-0000-000000000014"),
                columns: new[] { "CategoryId", "CheckpointDescription", "ItemNumber", "ReferenceId" },
                values: new object[] { null, "Ensure the completion of MEP and other discipline works above the false ceiling level and obtain clearance to proceed for further works.", null, null });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: new Guid("20000001-0000-0000-0000-000000000015"),
                columns: new[] { "CategoryId", "CheckpointDescription", "ItemNumber", "ReferenceId" },
                values: new object[] { null, "Verify the marking, position and alignment of MEP & wall mounted fixtures in the wall as per the approved drawings.", null, null });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: new Guid("20000001-0000-0000-0000-000000000016"),
                columns: new[] { "CategoryId", "CheckpointDescription", "ItemNumber", "ReferenceId" },
                values: new object[] { null, "Ensure the cutting of gypsum board on the marked locations as per the project requirements.", null, null });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: new Guid("20000001-0000-0000-0000-000000000017"),
                columns: new[] { "CategoryId", "CheckpointDescription", "ItemNumber", "ReferenceId" },
                values: new object[] { null, "Verify the jointing & taping as per the manufacturer recommendations.", null, null });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: new Guid("20000001-0000-0000-0000-000000000018"),
                columns: new[] { "CategoryId", "CheckpointDescription", "ItemNumber", "ReferenceId" },
                values: new object[] { null, "Approval obtain from Consultant/Client to proceed with further activities.", null, null });
        }
    }
}
