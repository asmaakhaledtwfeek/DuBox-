...
public static class RoleAndUserSeedData
{
    ...
    private static List<User> CreateUsers()
    {
        ...
        {
            new User { UserId = Guid.Parse("F1111111-1111-1111-1111-111111111111"), Email = "admin@groupamana.com", PasswordHash = defaultPassword, FullName = "System Administrator", Department = "IT", IsActive = true, CreatedDate = seedDate },
            
            new User { UserId = Guid.Parse("F2222222-2222-2222-2222-222222222222"), Email = "ahmed.almazrouei@groupamana.com", PasswordHash = defaultPassword, FullName = "Ahmed Al Mazrouei", Department = "Management", IsActive = true, CreatedDate = seedDate },
            new User { UserId = Guid.Parse("F3333333-3333-3333-3333-333333333333"), Email = "sara.alkhan@groupamana.com", PasswordHash = defaultPassword, FullName = "Sara Al Khan", Department = "Management", IsActive = true, CreatedDate = seedDate },
            
            new User { UserId = Guid.Parse("F4444444-4444-4444-4444-444444444444"), Email = "mohammed.hassan@groupamana.com", PasswordHash = defaultPassword, FullName = "Mohammed Hassan", Department = "Engineering", IsActive = true, CreatedDate = seedDate },
            new User { UserId = Guid.Parse("F5555555-5555-5555-5555-555555555555"), Email = "fatima.alali@groupamana.com", PasswordHash = defaultPassword, FullName = "Fatima Al Ali", Department = "Engineering", IsActive = true, CreatedDate = seedDate },
            new User { UserId = Guid.Parse("F6666666-6666-6666-6666-666666666666"), Email = "khalid.omar@groupamana.com", PasswordHash = defaultPassword, FullName = "Khalid Omar", Department = "Engineering", IsActive = true, CreatedDate = seedDate },
            
            new User { UserId = Guid.Parse("F7777777-7777-7777-7777-777777777777"), Email = "ali.mohammed@groupamana.com", PasswordHash = defaultPassword, FullName = "Ali Mohammed", Department = "Construction", IsActive = true, CreatedDate = seedDate },
            new User { UserId = Guid.Parse("F8888888-8888-8888-8888-888888888888"), Email = "omar.saleh@groupamana.com", PasswordHash = defaultPassword, FullName = "Omar Saleh", Department = "Construction", IsActive = true, CreatedDate = seedDate },
            new User { UserId = Guid.Parse("F9999999-9999-9999-9999-999999999999"), Email = "youssef.ahmed@groupamana.com", PasswordHash = defaultPassword, FullName = "Youssef Ahmed", Department = "Construction", IsActive = true, CreatedDate = seedDate },
            
            new User { UserId = Guid.Parse("FAAAAAAA-AAAA-AAAA-AAAA-AAAAAAAAAAAA"), Email = "layla.ibrahim@groupamana.com", PasswordHash = defaultPassword, FullName = "Layla Ibrahim", Department = "Quality", IsActive = true, CreatedDate = seedDate },
            new User { UserId = Guid.Parse("FBBBBBBB-BBBB-BBBB-BBBB-BBBBBBBBBBBB"), Email = "hamza.khalil@groupamana.com", PasswordHash = defaultPassword, FullName = "Hamza Khalil", Department = "Quality", IsActive = true, CreatedDate = seedDate },
            
            new User { UserId = Guid.Parse("FCCCCCCC-CCCC-CCCC-CCCC-CCCCCCCCCCCC"), Email = "noor.alhassan@groupamana.com", PasswordHash = defaultPassword, FullName = "Noor Al Hassan", Department = "Procurement", IsActive = true, CreatedDate = seedDate },
            new User { UserId = Guid.Parse("FDDDDDDD-DDDD-DDDD-DDDD-DDDDDDDDDDDD"), Email = "zaid.mansour@groupamana.com", PasswordHash = defaultPassword, FullName = "Zaid Mansour", Department = "Procurement", IsActive = true, CreatedDate = seedDate },
            
            new User { UserId = Guid.Parse("FEEEEEEE-EEEE-EEEE-EEEE-EEEEEEEEEEEE"), Email = "maryam.Said@groupamana.com", PasswordHash = defaultPassword, FullName = "Maryam Said", Department = "HSE", IsActive = true, CreatedDate = seedDate },
            new User { UserId = Guid.Parse("FFFFFFFF-FFFF-FFFF-FFFF-FFFFFFFFFFFF"), Email = "tariq.abdullah@groupamana.com", PasswordHash = defaultPassword, FullName = "Tariq Abdullah", Department = "HSE", IsActive = true, CreatedDate = seedDate },
            
            new User { UserId = Guid.Parse("F0000001-0000-0000-0000-000000000001"), Email = "rania.khalifa@groupamana.com", PasswordHash = defaultPassword, FullName = "Rania Khalifa", Department = "DuBox", IsActive = true, CreatedDate = seedDate },
            new User { UserId = Guid.Parse("F0000002-0000-0000-0000-000000000002"), Email = "salim.rashid@groupamana.com", PasswordHash = defaultPassword, FullName = "Salim Rashid", Department = "DuBox", IsActive = true, CreatedDate = seedDate },
            
            new User { UserId = Guid.Parse("F0000003-0000-0000-0000-000000000003"), Email = "huda.almarri@groupamana.com", PasswordHash = defaultPassword, FullName = "Huda Al Marri", Department = "DuPod", IsActive = true, CreatedDate = seedDate },
            new User { UserId = Guid.Parse("F0000004-0000-0000-0000-000000000004"), Email = "faisal.sultan@groupamana.com", PasswordHash = defaultPassword, FullName = "Faisal Sultan", Department = "DuPod", IsActive = true, CreatedDate = seedDate }
        };
    }
