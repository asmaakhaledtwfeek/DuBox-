...
/// </summary>
public class ScheduleActivityExcelImportService
{
    private readonly ApplicationDbContext _context;
    private readonly ILogger<ScheduleActivityExcelImportService> _logger;

    public ScheduleActivityExcelImportService(
        ApplicationDbContext context,
        ILogger<ScheduleActivityExcelImportService> logger)
    {
        _context = context;
        _logger = logger;
    ...
    public async Task<ImportResult> ImportFromExcelAsync(string filePath, Guid? projectId = null, string? sheetName = null)
    {
    ...
    private List<ActivityWithHierarchy> ParseExcelDataWithIndentation(ExcelWorksheet worksheet, ImportResult result)
    {
...
/// <summary>
/// DTO for activities with hierarchy information
/// </summary>
internal class ActivityWithHierarchy
{
    public string ActivityCode { get; set; } = string.Empty;
    public string ActivityName { get; set; } = string.Empty;
    public int IndentLevel { get; set; }
    public ActivityWithHierarchy? ParentActivity { get; set; }
