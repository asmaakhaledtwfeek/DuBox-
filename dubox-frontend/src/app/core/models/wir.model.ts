...
export interface WIRCheckpoint {
  ...
  projectCode?: string;
  client?: string;
  /** Project creator user id – allows project creator to review checkpoints */
  projectCreatedBy?: string;
  /** Project manager user id – allows project manager to review checkpoints */
...
export type NCRType = 'Internal' | 'External';
