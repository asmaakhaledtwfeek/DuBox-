...
export class ReportsDashboardComponent implements OnInit {
  ...
  reports: ReportCard[] = [
    ...
    {
      id: 'panel-approvals',
      title: 'Panel Approvals Report',
      description: 'Track panel second approval status - view approved panels, boxes approval progress, and project-level panel type analysis with Excel export',
      icon: 'panels',
      color: 'green'
    }
  ];
  ...
  showReport(reportId: string): void {
    ...
    if (reportId === 'panel-approvals') {
      this.router.navigate(['/reports/panel-approvals']);
      return;
    }
    if (reportId === 'report-builder') {
      this.router.navigate(['/reports/builder']);
      return;
    }
    if (reportId === 'saved-reports') {
      this.router.navigate(['/reports/saved']);
      return;
    }
  ...
  getIconSvg(icon: string): string {
    const icons: Record<string, string> = {
      ...
      panels: '<rect x="3" y="3" width="7" height="7" rx="1"/><rect x="14" y="3" width="7" height="7" rx="1"/><rect x="14" y="14" width="7" height="7" rx="1"/><rect x="3" y="14" width="7" height="7" rx="1"/><path d="M9 11l2 2 4-4" transform="translate(-2, -2)"/>',
      builder: '<path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/><line x1="10" y1="9" x2="8" y2="9"/><circle cx="18" cy="18" r="3"/><line x1="20.2" y1="20.2" x2="22" y2="22"/>',
