...
export class HeaderComponent implements OnInit, OnDestroy {
  ...
  // Toast notifications (SignalR only; ToastService → ToastOverlayComponent)
  ...
  ngOnInit(): void {
    ...
    // ToastService dispatches app-toast → ToastOverlayComponent (above modals)
    // Header only shows SignalR notification toasts via showNotificationToast
    ...
    // Note: app-toast events are handled by ToastOverlayComponent (renders above modals)
    // Header still handles ToastService for non-modal contexts
  }
